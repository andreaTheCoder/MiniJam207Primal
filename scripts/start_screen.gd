...
@onready var start_screen_tutorial_button: Button = $CanvasLayer/VBoxContainer/StartScreenTutorialButton
@onready var start_screen_button: Button = $CanvasLayer/VBoxcontainer/StartScreenButton
